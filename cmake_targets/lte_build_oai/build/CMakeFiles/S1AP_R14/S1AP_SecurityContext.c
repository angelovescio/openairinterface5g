...
static asn_oer_constraints_t asn_OER_memb_S1AP_nextHopChainingCount_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..7) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_S1AP_SecurityContext_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct S1AP_SecurityContext, nextHopChainingCount),
		...
		0,
		{ &asn_OER_memb_S1AP_nextHopChainingCount_constr_2, &asn_PER_memb_S1AP_nextHopChainingCount_constr_2,  memb_S1AP_nextHopChainingCount_constraint_1 },
