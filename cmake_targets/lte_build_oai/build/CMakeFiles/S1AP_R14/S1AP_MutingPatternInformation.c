...
static asn_oer_constraints_t asn_OER_type_S1AP_muting_pattern_period_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_S1AP_muting_pattern_offset_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_S1AP_muting_pattern_period_2 = {
	...
	{ &asn_OER_type_S1AP_muting_pattern_period_constr_2, &asn_PER_type_S1AP_muting_pattern_period_constr_2, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_S1AP_MutingPatternInformation_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct S1AP_MutingPatternInformation, muting_pattern_offset),
		...
		0,
		{ &asn_OER_memb_S1AP_muting_pattern_offset_constr_9, &asn_PER_memb_S1AP_muting_pattern_offset_constr_9,  memb_S1AP_muting_pattern_offset_constraint_1 },
		0, 0, /* No default value */
