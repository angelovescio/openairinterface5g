...
static asn_oer_constraints_t asn_OER_memb_S1AP_mBSFN_AreaId_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
asn_TYPE_member_t asn_MBR_S1AP_MBSFN_ResultToLogInfo_1[] = {
	{ ATF_POINTER, 1, offsetof(struct S1AP_MBSFN_ResultToLogInfo, mBSFN_AreaId),
		...
		0,
		{ &asn_OER_memb_S1AP_mBSFN_AreaId_constr_2, &asn_PER_memb_S1AP_mBSFN_AreaId_constr_2,  memb_S1AP_mBSFN_AreaId_constraint_1 },
