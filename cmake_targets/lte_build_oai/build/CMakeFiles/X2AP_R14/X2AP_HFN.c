 ...
 */
static asn_oer_constraints_t asn_OER_type_X2AP_HFN_constr_1 CC_NOTUSED = {
	{ 4, 1 }	/* (0..1048575) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_X2AP_HFN = {
	...
	sizeof(asn_DEF_X2AP_HFN_tags_1)
		/sizeof(asn_DEF_X2AP_HFN_tags_1[0]), /* 1 */
	{ &asn_OER_type_X2AP_HFN_constr_1, &asn_PER_type_X2AP_HFN_constr_1, X2AP_HFN_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
