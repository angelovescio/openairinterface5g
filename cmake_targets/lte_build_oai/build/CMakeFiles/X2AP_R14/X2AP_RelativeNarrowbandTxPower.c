...
static asn_oer_constraints_t asn_OER_type_X2AP_numberOfCellSpecificAntennaPorts_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_X2AP_rNTP_PerPRB_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
static asn_oer_constraints_t asn_OER_memb_X2AP_p_B_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_X2AP_pDCCH_InterferenceImpact_constr_10 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_X2AP_numberOfCellSpecificAntennaPorts_4 = {
	...
	{ &asn_OER_type_X2AP_numberOfCellSpecificAntennaPorts_constr_4, &asn_PER_type_X2AP_numberOfCellSpecificAntennaPorts_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_X2AP_RelativeNarrowbandTxPower_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_RelativeNarrowbandTxPower, rNTP_PerPRB),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_X2AP_rNTP_PerPRB_constr_2, &asn_PER_memb_X2AP_rNTP_PerPRB_constr_2,  memb_X2AP_rNTP_PerPRB_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_RelativeNarrowbandTxPower, p_B),
		...
		0,
		{ &asn_OER_memb_X2AP_p_B_constr_9, &asn_PER_memb_X2AP_p_B_constr_9,  memb_X2AP_p_B_constraint_1 },
		0, 0, /* No default value */
		"p-B"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_RelativeNarrowbandTxPower, pDCCH_InterferenceImpact),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_X2AP_pDCCH_InterferenceImpact_constr_10, &asn_PER_memb_X2AP_pDCCH_InterferenceImpact_constr_10,  memb_X2AP_pDCCH_InterferenceImpact_constraint_1 },
		0, 0, /* No default value */
