...
static asn_oer_constraints_t asn_OER_memb_X2AP_handoverTriggerChangeLowerLimit_constr_2 CC_NOTUSED = {
	{ 1, 0 }	/* (-20..20) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_X2AP_handoverTriggerChangeUpperLimit_constr_3 CC_NOTUSED = {
	{ 1, 0 }	/* (-20..20) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_X2AP_MobilityParametersModificationRange_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_MobilityParametersModificationRange, handoverTriggerChangeLowerLimit),
		...
		0,
		{ &asn_OER_memb_X2AP_handoverTriggerChangeLowerLimit_constr_2, &asn_PER_memb_X2AP_handoverTriggerChangeLowerLimit_constr_2,  memb_X2AP_handoverTriggerChangeLowerLimit_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_MobilityParametersModificationRange, handoverTriggerChangeUpperLimit),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_X2AP_handoverTriggerChangeUpperLimit_constr_3, &asn_PER_memb_X2AP_handoverTriggerChangeUpperLimit_constr_3,  memb_X2AP_handoverTriggerChangeUpperLimit_constraint_1 },
		0, 0, /* No default value */
