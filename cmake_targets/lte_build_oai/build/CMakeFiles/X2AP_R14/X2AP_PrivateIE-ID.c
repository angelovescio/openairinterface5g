...
static asn_oer_constraints_t asn_OER_memb_X2AP_local_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (0..65535) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_X2AP_PrivateIE_ID_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_X2AP_PrivateIE_ID_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_PrivateIE_ID, choice.local),
		...
		0,
		{ &asn_OER_memb_X2AP_local_constr_2, &asn_PER_memb_X2AP_local_constr_2,  memb_X2AP_local_constraint_1 },
...
asn_TYPE_descriptor_t asn_DEF_X2AP_PrivateIE_ID = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_X2AP_PrivateIE_ID_constr_1, &asn_PER_type_X2AP_PrivateIE_ID_constr_1, CHOICE_constraint },
