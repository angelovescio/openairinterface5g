...
static asn_oer_constraints_t asn_OER_memb_X2AP_startSFN_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_X2AP_startSubframeNumber_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_X2AP_EnhancedRNTPStartTime_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_EnhancedRNTPStartTime, startSFN),
		...
		0,
		{ &asn_OER_memb_X2AP_startSFN_constr_2, &asn_PER_memb_X2AP_startSFN_constr_2,  memb_X2AP_startSFN_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_EnhancedRNTPStartTime, startSubframeNumber),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_X2AP_startSubframeNumber_constr_3, &asn_PER_memb_X2AP_startSubframeNumber_constr_3,  memb_X2AP_startSubframeNumber_constraint_1 },
		0, 0, /* No default value */
		"startSubframeNumber"
		},
