...
static asn_oer_constraints_t asn_OER_type_X2AP_pA_list_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..3)) */};
...
static asn_oer_constraints_t asn_OER_memb_X2AP_transmissionModes_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	8	/* (SIZE(8..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_X2AP_pB_information_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..3) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_X2AP_pA_list_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..3)) */};
...
asn_TYPE_descriptor_t asn_DEF_X2AP_pA_list_4 = {
	...
	{ &asn_OER_type_X2AP_pA_list_constr_4, &asn_PER_type_X2AP_pA_list_constr_4, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_X2AP_DynamicNAICSInformation_1[] = {
	{ ATF_POINTER, 2, offsetof(struct X2AP_DynamicNAICSInformation, transmissionModes),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_X2AP_transmissionModes_constr_2, &asn_PER_memb_X2AP_transmissionModes_constr_2,  memb_X2AP_transmissionModes_constraint_1 },
		0, 0, /* No default value */
		"transmissionModes"
		},
	{ ATF_POINTER, 1, offsetof(struct X2AP_DynamicNAICSInformation, pB_information),
		...
		0,
		{ &asn_OER_memb_X2AP_pB_information_constr_3, &asn_PER_memb_X2AP_pB_information_constr_3,  memb_X2AP_pB_information_constraint_1 },
		0, 0, /* No default value */
		"pB-information"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_DynamicNAICSInformation, pA_list),
		...
		0,
		{ &asn_OER_memb_X2AP_pA_list_constr_4, &asn_PER_memb_X2AP_pA_list_constr_4,  memb_X2AP_pA_list_constraint_1 },
		0, 0, /* No default value */
		"pA-list"
		},
