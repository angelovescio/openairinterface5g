...
static asn_oer_constraints_t asn_OER_memb_X2AP_widebandCQICodeword0_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_X2AP_WidebandCQI_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_WidebandCQI, widebandCQICodeword0),
		...
		0,
		{ &asn_OER_memb_X2AP_widebandCQICodeword0_constr_2, &asn_PER_memb_X2AP_widebandCQICodeword0_constr_2,  memb_X2AP_widebandCQICodeword0_constraint_1 },
