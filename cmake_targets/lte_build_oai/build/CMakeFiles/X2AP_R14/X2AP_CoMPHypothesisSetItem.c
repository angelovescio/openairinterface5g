...
static asn_oer_constraints_t asn_OER_memb_X2AP_coMPHypothesis_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
asn_TYPE_member_t asn_MBR_X2AP_CoMPHypothesisSetItem_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_CoMPHypothesisSetItem, coMPHypothesis),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_X2AP_coMPHypothesis_constr_3, &asn_PER_memb_X2AP_coMPHypothesis_constr_3,  memb_X2AP_coMPHypothesis_constraint_1 },
		0, 0, /* No default value */
		"coMPHypothesis"
		},
