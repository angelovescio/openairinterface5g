...
static asn_oer_constraints_t asn_OER_type_X2AP_numberOfCellSpecificAntennaPorts_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_X2AP_abs_pattern_info_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	40	/* (SIZE(40..40)) */};
...
static asn_oer_constraints_t asn_OER_memb_X2AP_measurement_subset_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	40	/* (SIZE(40..40)) */};
...
asn_TYPE_descriptor_t asn_DEF_X2AP_numberOfCellSpecificAntennaPorts_3 = {
	...
	{ &asn_OER_type_X2AP_numberOfCellSpecificAntennaPorts_constr_3, &asn_PER_type_X2AP_numberOfCellSpecificAntennaPorts_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_X2AP_ABSInformationFDD_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_ABSInformationFDD, abs_pattern_info),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_X2AP_abs_pattern_info_constr_2, &asn_PER_memb_X2AP_abs_pattern_info_constr_2,  memb_X2AP_abs_pattern_info_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_ABSInformationFDD, measurement_subset),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_X2AP_measurement_subset_constr_8, &asn_PER_memb_X2AP_measurement_subset_constr_8,  memb_X2AP_measurement_subset_constraint_1 },
		0, 0, /* No default value */
		"measurement-subset"
		},
