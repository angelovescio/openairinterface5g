...
static asn_oer_constraints_t asn_OER_memb_X2AP_procedureCode_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
asn_TYPE_member_t asn_MBR_X2AP_SuccessfulOutcome_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_SuccessfulOutcome, procedureCode),
		...
		0,
		{ &asn_OER_memb_X2AP_procedureCode_constr_2, &asn_PER_memb_X2AP_procedureCode_constr_2,  memb_X2AP_procedureCode_constraint_1 },
		0, 0, /* No default value */
		"procedureCode"
		},
