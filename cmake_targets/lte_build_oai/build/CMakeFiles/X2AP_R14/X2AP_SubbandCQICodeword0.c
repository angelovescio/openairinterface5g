...
static asn_oer_constraints_t asn_OER_memb_X2AP_two_bitSubbandDifferentialCQI_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_X2AP_two_bitDifferentialCQI_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_X2AP_SubbandCQICodeword0_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_X2AP_SubbandCQICodeword0_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_SubbandCQICodeword0, choice.two_bitSubbandDifferentialCQI),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_X2AP_two_bitSubbandDifferentialCQI_constr_3, &asn_PER_memb_X2AP_two_bitSubbandDifferentialCQI_constr_3,  memb_X2AP_two_bitSubbandDifferentialCQI_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_SubbandCQICodeword0, choice.two_bitDifferentialCQI),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_X2AP_two_bitDifferentialCQI_constr_4, &asn_PER_memb_X2AP_two_bitDifferentialCQI_constr_4,  memb_X2AP_two_bitDifferentialCQI_constraint_1 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_X2AP_SubbandCQICodeword0 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_X2AP_SubbandCQICodeword0_constr_1, &asn_PER_type_X2AP_SubbandCQICodeword0_constr_1, CHOICE_constraint },
