...
static asn_oer_constraints_t asn_OER_memb_X2AP_rootSequenceIndex_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (0..837) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_X2AP_zeroCorrelationIndex_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_X2AP_prach_FreqOffset_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..94) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_X2AP_prach_ConfigIndex_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (0..63) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_X2AP_PRACH_Configuration_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_PRACH_Configuration, rootSequenceIndex),
		...
		0,
		{ &asn_OER_memb_X2AP_rootSequenceIndex_constr_2, &asn_PER_memb_X2AP_rootSequenceIndex_constr_2,  memb_X2AP_rootSequenceIndex_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_PRACH_Configuration, zeroCorrelationIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_X2AP_zeroCorrelationIndex_constr_3, &asn_PER_memb_X2AP_zeroCorrelationIndex_constr_3,  memb_X2AP_zeroCorrelationIndex_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_PRACH_Configuration, prach_FreqOffset),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_X2AP_prach_FreqOffset_constr_5, &asn_PER_memb_X2AP_prach_FreqOffset_constr_5,  memb_X2AP_prach_FreqOffset_constraint_1 },
		0, 0, /* No default value */
		"prach-FreqOffset"
		},
	{ ATF_POINTER, 2, offsetof(struct X2AP_PRACH_Configuration, prach_ConfigIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_X2AP_prach_ConfigIndex_constr_6, &asn_PER_memb_X2AP_prach_ConfigIndex_constr_6,  memb_X2AP_prach_ConfigIndex_constraint_1 },
		0, 0, /* No default value */
		"prach-ConfigIndex"
		},
