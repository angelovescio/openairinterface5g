...
static asn_oer_constraints_t asn_OER_memb_X2AP_cSIProcessConfigurationIndex_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_X2AP_CSIReportPerCSIProcess_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
...
static asn_TYPE_member_t asn_MBR_X2AP_Member_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_CSIReportPerCSIProcess__Member, cSIProcessConfigurationIndex),
		...
		0,
		{ &asn_OER_memb_X2AP_cSIProcessConfigurationIndex_constr_3, &asn_PER_memb_X2AP_cSIProcessConfigurationIndex_constr_3,  memb_X2AP_cSIProcessConfigurationIndex_constraint_2 },
...
asn_TYPE_descriptor_t asn_DEF_X2AP_CSIReportPerCSIProcess = {
	...
	sizeof(asn_DEF_X2AP_CSIReportPerCSIProcess_tags_1)
		/sizeof(asn_DEF_X2AP_CSIReportPerCSIProcess_tags_1[0]), /* 1 */
	{ &asn_OER_type_X2AP_CSIReportPerCSIProcess_constr_1, &asn_PER_type_X2AP_CSIReportPerCSIProcess_constr_1, SEQUENCE_OF_constraint },
