...
static asn_oer_constraints_t asn_OER_memb_X2AP_enhancedRNTPBitmap_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
static asn_TYPE_member_t asn_MBR_X2AP_EnhancedRNTP_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_EnhancedRNTP, enhancedRNTPBitmap),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_X2AP_enhancedRNTPBitmap_constr_2, &asn_PER_memb_X2AP_enhancedRNTPBitmap_constr_2,  memb_X2AP_enhancedRNTPBitmap_constraint_1 },
