...
static asn_oer_constraints_t asn_OER_memb_X2AP_handoverTriggerChange_constr_2 CC_NOTUSED = {
	{ 1, 0 }	/* (-20..20) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_X2AP_MobilityParametersInformation_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_MobilityParametersInformation, handoverTriggerChange),
		...
		0,
		{ &asn_OER_memb_X2AP_handoverTriggerChange_constr_2, &asn_PER_memb_X2AP_handoverTriggerChange_constr_2,  memb_X2AP_handoverTriggerChange_constraint_1 },
