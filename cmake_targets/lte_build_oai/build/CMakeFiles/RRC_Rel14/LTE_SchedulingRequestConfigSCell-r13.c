...
static asn_oer_constraints_t asn_OER_type_LTE_dsr_TransMax_r13_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_sr_PUCCH_ResourceIndex_r13_constr_4 CC_NOTUSED = {
	{ 2, 1 }	/* (0..2047) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_sr_PUCCH_ResourceIndexP1_r13_constr_5 CC_NOTUSED = {
	{ 2, 1 }	/* (0..2047) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_sr_ConfigIndex_r13_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (0..157) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_SchedulingRequestConfigSCell_r13_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_dsr_TransMax_r13_7 = {
	...
	{ &asn_OER_type_LTE_dsr_TransMax_r13_constr_7, &asn_PER_type_LTE_dsr_TransMax_r13_constr_7, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_LTE_setup_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SchedulingRequestConfigSCell_r13__setup, sr_PUCCH_ResourceIndex_r13),
		...
		0,
		{ &asn_OER_memb_LTE_sr_PUCCH_ResourceIndex_r13_constr_4, &asn_PER_memb_LTE_sr_PUCCH_ResourceIndex_r13_constr_4,  memb_LTE_sr_PUCCH_ResourceIndex_r13_constraint_3 },
	...
	{ ATF_POINTER, 1, offsetof(struct LTE_SchedulingRequestConfigSCell_r13__setup, sr_PUCCH_ResourceIndexP1_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_sr_PUCCH_ResourceIndexP1_r13_constr_5, &asn_PER_memb_LTE_sr_PUCCH_ResourceIndexP1_r13_constr_5,  memb_LTE_sr_PUCCH_ResourceIndexP1_r13_constraint_3 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SchedulingRequestConfigSCell_r13__setup, sr_ConfigIndex_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_sr_ConfigIndex_r13_constr_6, &asn_PER_memb_LTE_sr_ConfigIndex_r13_constr_6,  memb_LTE_sr_ConfigIndex_r13_constraint_3 },
		0, 0, /* No default value */
		"sr-ConfigIndex-r13"
		},
...
asn_TYPE_descriptor_t asn_DEF_LTE_SchedulingRequestConfigSCell_r13 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_SchedulingRequestConfigSCell_r13_constr_1, &asn_PER_type_LTE_SchedulingRequestConfigSCell_r13_constr_1, CHOICE_constraint },
