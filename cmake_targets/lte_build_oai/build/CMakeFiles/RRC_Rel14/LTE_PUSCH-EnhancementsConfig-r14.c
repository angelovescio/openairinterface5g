...
static asn_oer_constraints_t asn_OER_type_LTE_interval_FDD_PUSCH_Enh_r14_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_interval_TDD_PUSCH_Enh_r14_constr_11 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_interval_ULHoppingPUSCH_Enh_r14_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_pusch_HoppingOffsetPUSCH_Enh_r14_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (1..100) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_PUSCH_EnhancementsConfig_r14_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_interval_FDD_PUSCH_Enh_r14_6 = {
	...
	{ &asn_OER_type_LTE_interval_FDD_PUSCH_Enh_r14_constr_6, &asn_PER_type_LTE_interval_FDD_PUSCH_Enh_r14_constr_6, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_LTE_interval_TDD_PUSCH_Enh_r14_11 = {
	...
	{ &asn_OER_type_LTE_interval_TDD_PUSCH_Enh_r14_constr_11, &asn_PER_type_LTE_interval_TDD_PUSCH_Enh_r14_constr_11, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_LTE_interval_ULHoppingPUSCH_Enh_r14_5 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_interval_ULHoppingPUSCH_Enh_r14_constr_5, &asn_PER_type_LTE_interval_ULHoppingPUSCH_Enh_r14_constr_5, CHOICE_constraint },
...
static asn_TYPE_member_t asn_MBR_LTE_setup_3[] = {
	{ ATF_POINTER, 2, offsetof(struct LTE_PUSCH_EnhancementsConfig_r14__setup, pusch_HoppingOffsetPUSCH_Enh_r14),
		...
		0,
		{ &asn_OER_memb_LTE_pusch_HoppingOffsetPUSCH_Enh_r14_constr_4, &asn_PER_memb_LTE_pusch_HoppingOffsetPUSCH_Enh_r14_constr_4,  memb_LTE_pusch_HoppingOffsetPUSCH_Enh_r14_constraint_3 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_LTE_PUSCH_EnhancementsConfig_r14 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_PUSCH_EnhancementsConfig_r14_constr_1, &asn_PER_type_LTE_PUSCH_EnhancementsConfig_r14_constr_1, CHOICE_constraint },
