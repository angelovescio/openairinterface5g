...
static asn_oer_constraints_t asn_OER_type_LTE_drb_TypeChange_r12_constr_10 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_drb_TypeLWIP_r13_constr_16 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_lwa_WLAN_AC_r14_constr_25 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_eps_BearerIdentity_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_logicalChannelIdentity_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (3..10) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_drb_TypeChange_r12_10 = {
	...
	{ &asn_OER_type_LTE_drb_TypeChange_r12_constr_10, &asn_PER_type_LTE_drb_TypeChange_r12_constr_10, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_LTE_drb_TypeLWIP_r13_16 = {
	...
	{ &asn_OER_type_LTE_drb_TypeLWIP_r13_constr_16, &asn_PER_type_LTE_drb_TypeLWIP_r13_constr_16, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_LTE_lwa_WLAN_AC_r14_25 = {
	...
	{ &asn_OER_type_LTE_lwa_WLAN_AC_r14_constr_25, &asn_PER_type_LTE_lwa_WLAN_AC_r14_constr_25, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_LTE_DRB_ToAddMod_1[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_DRB_ToAddMod, eps_BearerIdentity),
		...
		0,
		{ &asn_OER_memb_LTE_eps_BearerIdentity_constr_2, &asn_PER_memb_LTE_eps_BearerIdentity_constr_2,  memb_LTE_eps_BearerIdentity_constraint_1 },
		0, 0, /* No default value */
		"eps-BearerIdentity"
		},
	...
	{ ATF_POINTER, 5, offsetof(struct LTE_DRB_ToAddMod, logicalChannelIdentity),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_logicalChannelIdentity_constr_6, &asn_PER_memb_LTE_logicalChannelIdentity_constr_6,  memb_LTE_logicalChannelIdentity_constraint_1 },
		0, 0, /* No default value */
