...
static asn_oer_constraints_t asn_OER_type_LTE_ac_BarringFactor_r13_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_ac_BarringTime_r13_constr_21 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_acdc_Category_r13_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..16) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_ac_BarringFactor_r13_4 = {
	...
	{ &asn_OER_type_LTE_ac_BarringFactor_r13_constr_4, &asn_PER_type_LTE_ac_BarringFactor_r13_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_LTE_ac_BarringTime_r13_21 = {
	...
	{ &asn_OER_type_LTE_ac_BarringTime_r13_constr_21, &asn_PER_type_LTE_ac_BarringTime_r13_constr_21, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_LTE_BarringPerACDC_Category_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_BarringPerACDC_Category_r13, acdc_Category_r13),
		...
		0,
		{ &asn_OER_memb_LTE_acdc_Category_r13_constr_2, &asn_PER_memb_LTE_acdc_Category_r13_constr_2,  memb_LTE_acdc_Category_r13_constraint_1 },
		0, 0, /* No default value */
		"acdc-Category-r13"
		},
