...
static asn_oer_constraints_t asn_OER_type_LTE_pmi_RI_Report_r9_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_csi_SubframePatternConfig_r10_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_nomPDSCH_RS_EPRE_Offset_constr_3 CC_NOTUSED = {
	{ 1, 0 }	/* (-1..6) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_pmi_RI_Report_r9_5 = {
	...
	{ &asn_OER_type_LTE_pmi_RI_Report_r9_constr_5, &asn_PER_type_LTE_pmi_RI_Report_r9_constr_5, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_LTE_csi_SubframePatternConfig_r10_7 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_csi_SubframePatternConfig_r10_constr_7, &asn_PER_type_LTE_csi_SubframePatternConfig_r10_constr_7, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_CQI_ReportConfig_r10_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_CQI_ReportConfig_r10, nomPDSCH_RS_EPRE_Offset),
		...
		0,
		{ &asn_OER_memb_LTE_nomPDSCH_RS_EPRE_Offset_constr_3, &asn_PER_memb_LTE_nomPDSCH_RS_EPRE_Offset_constr_3,  memb_LTE_nomPDSCH_RS_EPRE_Offset_constraint_1 },
		0, 0, /* No default value */
