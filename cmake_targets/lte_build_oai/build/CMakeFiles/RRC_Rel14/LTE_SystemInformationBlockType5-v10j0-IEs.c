...
static asn_oer_constraints_t asn_OER_type_LTE_interFreqCarrierFreqList_v10j0_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_interFreqCarrierFreqList_v10j0_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
asn_TYPE_descriptor_t asn_DEF_LTE_interFreqCarrierFreqList_v10j0_2 = {
	...
	{ &asn_OER_type_LTE_interFreqCarrierFreqList_v10j0_constr_2, &asn_PER_type_LTE_interFreqCarrierFreqList_v10j0_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_SystemInformationBlockType5_v10j0_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct LTE_SystemInformationBlockType5_v10j0_IEs, interFreqCarrierFreqList_v10j0),
		...
		0,
		{ &asn_OER_memb_LTE_interFreqCarrierFreqList_v10j0_constr_2, &asn_PER_memb_LTE_interFreqCarrierFreqList_v10j0_constr_2,  memb_LTE_interFreqCarrierFreqList_v10j0_constraint_1 },
		0, 0, /* No default value */
		"interFreqCarrierFreqList-v10j0"
		},
