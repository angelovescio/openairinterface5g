...
static asn_oer_constraints_t asn_OER_memb_LTE_rootSequenceIndexHighSpeed_r14_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (0..837) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_zeroCorrelationZoneConfigHighSpeed_r14_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..12) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_prach_ConfigIndexHighSpeed_r14_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..63) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_prach_FreqOffsetHighSpeed_r14_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..94) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_PRACH_Config_v1430_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_PRACH_Config_v1430, rootSequenceIndexHighSpeed_r14),
		...
		0,
		{ &asn_OER_memb_LTE_rootSequenceIndexHighSpeed_r14_constr_2, &asn_PER_memb_LTE_rootSequenceIndexHighSpeed_r14_constr_2,  memb_LTE_rootSequenceIndexHighSpeed_r14_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_PRACH_Config_v1430, zeroCorrelationZoneConfigHighSpeed_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_zeroCorrelationZoneConfigHighSpeed_r14_constr_3, &asn_PER_memb_LTE_zeroCorrelationZoneConfigHighSpeed_r14_constr_3,  memb_LTE_zeroCorrelationZoneConfigHighSpeed_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_PRACH_Config_v1430, prach_ConfigIndexHighSpeed_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_prach_ConfigIndexHighSpeed_r14_constr_4, &asn_PER_memb_LTE_prach_ConfigIndexHighSpeed_r14_constr_4,  memb_LTE_prach_ConfigIndexHighSpeed_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_PRACH_Config_v1430, prach_FreqOffsetHighSpeed_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_prach_FreqOffsetHighSpeed_r14_constr_5, &asn_PER_memb_LTE_prach_FreqOffsetHighSpeed_r14_constr_5,  memb_LTE_prach_FreqOffsetHighSpeed_r14_constraint_1 },
		0, 0, /* No default value */
