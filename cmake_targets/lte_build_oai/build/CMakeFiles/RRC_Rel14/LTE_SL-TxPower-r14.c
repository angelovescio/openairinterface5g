...
static asn_oer_constraints_t asn_OER_memb_LTE_txPower_r14_constr_3 CC_NOTUSED = {
	{ 1, 0 }	/* (-41..31) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_SL_TxPower_r14_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_SL_TxPower_r14_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SL_TxPower_r14, choice.txPower_r14),
		...
		0,
		{ &asn_OER_memb_LTE_txPower_r14_constr_3, &asn_PER_memb_LTE_txPower_r14_constr_3,  memb_LTE_txPower_r14_constraint_1 },
		0, 0, /* No default value */
		"txPower-r14"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_LTE_SL_TxPower_r14 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_SL_TxPower_r14_constr_1, &asn_PER_type_LTE_SL_TxPower_r14_constr_1, CHOICE_constraint },
