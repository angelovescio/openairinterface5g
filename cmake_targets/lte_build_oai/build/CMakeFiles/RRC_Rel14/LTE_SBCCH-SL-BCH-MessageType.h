...
ber_type_decoder_f LTE_SBCCH_SL_BCH_MessageType_decode_ber;
der_type_encoder_f LTE_SBCCH_SL_BCH_MessageType_encode_der;
xer_type_decoder_f LTE_SBCCH_SL_BCH_MessageType_decode_xer;
xer_type_encoder_f LTE_SBCCH_SL_BCH_MessageType_encode_xer;
oer_type_decoder_f LTE_SBCCH_SL_BCH_MessageType_decode_oer;
oer_type_encoder_f LTE_SBCCH_SL_BCH_MessageType_encode_oer;
