...
static asn_oer_constraints_t asn_OER_memb_LTE_plmn_Index_r12_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..6) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_PLMN_IdentityInfo2_r12_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_PLMN_IdentityInfo2_r12_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_PLMN_IdentityInfo2_r12, choice.plmn_Index_r12),
		...
		0,
		{ &asn_OER_memb_LTE_plmn_Index_r12_constr_2, &asn_PER_memb_LTE_plmn_Index_r12_constr_2,  memb_LTE_plmn_Index_r12_constraint_1 },
...
asn_TYPE_descriptor_t asn_DEF_LTE_PLMN_IdentityInfo2_r12 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_PLMN_IdentityInfo2_r12_constr_1, &asn_PER_type_LTE_PLMN_IdentityInfo2_r12_constr_1, CHOICE_constraint },
