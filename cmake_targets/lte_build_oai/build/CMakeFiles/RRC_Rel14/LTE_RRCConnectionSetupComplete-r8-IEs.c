...
static asn_oer_constraints_t asn_OER_memb_LTE_selectedPLMN_Identity_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..6) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_RRCConnectionSetupComplete_r8_IEs_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RRCConnectionSetupComplete_r8_IEs, selectedPLMN_Identity),
		...
		0,
		{ &asn_OER_memb_LTE_selectedPLMN_Identity_constr_2, &asn_PER_memb_LTE_selectedPLMN_Identity_constr_2,  memb_LTE_selectedPLMN_Identity_constraint_1 },
