...
static asn_oer_constraints_t asn_OER_memb_LTE_mpdcch_NumRepetition_r13_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (1..256) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_UEPagingCoverageInformation_r13_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct LTE_UEPagingCoverageInformation_r13_IEs, mpdcch_NumRepetition_r13),
		...
		0,
		{ &asn_OER_memb_LTE_mpdcch_NumRepetition_r13_constr_2, &asn_PER_memb_LTE_mpdcch_NumRepetition_r13_constr_2,  memb_LTE_mpdcch_NumRepetition_r13_constraint_1 },
