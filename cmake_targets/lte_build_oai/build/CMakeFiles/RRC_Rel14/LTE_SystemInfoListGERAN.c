...
static asn_oer_constraints_t asn_OER_type_LTE_SystemInfoListGERAN_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..10)) */};
...
asn_TYPE_member_t asn_MBR_LTE_SystemInfoListGERAN_1[] = {
	{ ATF_POINTER, 0, 0,
		...
		0,
		{ &asn_OER_memb_LTE_Member_constr_2, &asn_PER_memb_LTE_Member_constr_2,  memb_OCTET_STRING_constraint_1 },
...
asn_TYPE_descriptor_t asn_DEF_LTE_SystemInfoListGERAN = {
	...
	sizeof(asn_DEF_LTE_SystemInfoListGERAN_tags_1)
		/sizeof(asn_DEF_LTE_SystemInfoListGERAN_tags_1[0]), /* 1 */
	{ &asn_OER_type_LTE_SystemInfoListGERAN_constr_1, &asn_PER_type_LTE_SystemInfoListGERAN_constr_1, SEQUENCE_OF_constraint },
