...
static asn_oer_constraints_t asn_OER_memb_LTE_resourceConfig_r12_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..31) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_subframeConfig_r12_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..154) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_CSI_IM_ConfigExt_r12_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_CSI_IM_ConfigExt_r12, resourceConfig_r12),
		...
		0,
		{ &asn_OER_memb_LTE_resourceConfig_r12_constr_3, &asn_PER_memb_LTE_resourceConfig_r12_constr_3,  memb_LTE_resourceConfig_r12_constraint_1 },
		0, 0, /* No default value */
		"resourceConfig-r12"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_CSI_IM_ConfigExt_r12, subframeConfig_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_subframeConfig_r12_constr_4, &asn_PER_memb_LTE_subframeConfig_r12_constr_4,  memb_LTE_subframeConfig_r12_constraint_1 },
		0, 0, /* No default value */
		"subframeConfig-r12"
		},
