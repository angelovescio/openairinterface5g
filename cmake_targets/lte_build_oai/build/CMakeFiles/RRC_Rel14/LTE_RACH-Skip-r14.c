...
static asn_oer_constraints_t asn_OER_type_LTE_targetTA_r14_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_ul_SchedInterval_r14_constr_10 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_numberOfConfUL_Processes_r14_constr_9 CC_NOTUSED = {
	{ 1, 1 }	/* (1..8) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_ul_StartSubframe_r14_constr_14 CC_NOTUSED = {
	{ 1, 1 }	/* (0..9) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_ul_Grant_r14_constr_15 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
asn_TYPE_descriptor_t asn_DEF_LTE_targetTA_r14_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_targetTA_r14_constr_2, &asn_PER_type_LTE_targetTA_r14_constr_2, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_LTE_ul_SchedInterval_r14_10 = {
	...
	{ &asn_OER_type_LTE_ul_SchedInterval_r14_constr_10, &asn_PER_type_LTE_ul_SchedInterval_r14_constr_10, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_LTE_ul_ConfigInfo_r14_8[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RACH_Skip_r14__ul_ConfigInfo_r14, numberOfConfUL_Processes_r14),
		...
		0,
		{ &asn_OER_memb_LTE_numberOfConfUL_Processes_r14_constr_9, &asn_PER_memb_LTE_numberOfConfUL_Processes_r14_constr_9,  memb_LTE_numberOfConfUL_Processes_r14_constraint_8 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RACH_Skip_r14__ul_ConfigInfo_r14, ul_StartSubframe_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_ul_StartSubframe_r14_constr_14, &asn_PER_memb_LTE_ul_StartSubframe_r14_constr_14,  memb_LTE_ul_StartSubframe_r14_constraint_8 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RACH_Skip_r14__ul_ConfigInfo_r14, ul_Grant_r14),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_ul_Grant_r14_constr_15, &asn_PER_memb_LTE_ul_Grant_r14_constr_15,  memb_LTE_ul_Grant_r14_constraint_8 },
		0, 0, /* No default value */
		"ul-Grant-r14"
		},
};
