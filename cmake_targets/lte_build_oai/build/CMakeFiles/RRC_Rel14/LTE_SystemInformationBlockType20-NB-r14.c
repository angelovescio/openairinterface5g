...
static asn_oer_constraints_t asn_OER_memb_LTE_dl_CarrierIndex_r14_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_sc_mcch_CarrierConfig_r14_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_sc_mcch_RepetitionPeriod_r14_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_sc_mcch_ModificationPeriod_r14_constr_16 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_sc_mcch_Offset_r14_constr_15 CC_NOTUSED = {
	{ 1, 1 }	/* (0..10) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_LTE_sc_mcch_CarrierConfig_r14_3[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SystemInformationBlockType20_NB_r14__sc_mcch_CarrierConfig_r14, choice.dl_CarrierIndex_r14),
		...
		0,
		{ &asn_OER_memb_LTE_dl_CarrierIndex_r14_constr_5, &asn_PER_memb_LTE_dl_CarrierIndex_r14_constr_5,  memb_LTE_dl_CarrierIndex_r14_constraint_3 },
		0, 0, /* No default value */
		"dl-CarrierIndex-r14"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_LTE_sc_mcch_CarrierConfig_r14_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_sc_mcch_CarrierConfig_r14_constr_3, &asn_PER_type_LTE_sc_mcch_CarrierConfig_r14_constr_3, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_LTE_sc_mcch_RepetitionPeriod_r14_6 = {
	...
	{ &asn_OER_type_LTE_sc_mcch_RepetitionPeriod_r14_constr_6, &asn_PER_type_LTE_sc_mcch_RepetitionPeriod_r14_constr_6, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_LTE_sc_mcch_ModificationPeriod_r14_16 = {
	...
	{ &asn_OER_type_LTE_sc_mcch_ModificationPeriod_r14_constr_16, &asn_PER_type_LTE_sc_mcch_ModificationPeriod_r14_constr_16, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_LTE_SystemInformationBlockType20_NB_r14_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SystemInformationBlockType20_NB_r14, sc_mcch_Offset_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_sc_mcch_Offset_r14_constr_15, &asn_PER_memb_LTE_sc_mcch_Offset_r14_constr_15,  memb_LTE_sc_mcch_Offset_r14_constraint_1 },
		0, 0, /* No default value */
		"sc-mcch-Offset-r14"
		},
