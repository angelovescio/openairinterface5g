...
static asn_oer_constraints_t asn_OER_memb_LTE_eps_BearerIdentity_r12_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_drb_Type_r12_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_logicalChannelIdentitySCG_r12_constr_10 CC_NOTUSED = {
	{ 1, 1 }	/* (3..10) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_LTE_scg_r12_5[] = {
	{ ATF_POINTER, 2, offsetof(struct LTE_DRB_ToAddModSCG_r12__drb_Type_r12__scg_r12, eps_BearerIdentity_r12),
		...
		0,
		{ &asn_OER_memb_LTE_eps_BearerIdentity_r12_constr_6, &asn_PER_memb_LTE_eps_BearerIdentity_r12_constr_6,  memb_LTE_eps_BearerIdentity_r12_constraint_5 },
...
asn_TYPE_descriptor_t asn_DEF_LTE_drb_Type_r12_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_drb_Type_r12_constr_3, &asn_PER_type_LTE_drb_Type_r12_constr_3, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_DRB_ToAddModSCG_r12_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct LTE_DRB_ToAddModSCG_r12, logicalChannelIdentitySCG_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_logicalChannelIdentitySCG_r12_constr_10, &asn_PER_memb_LTE_logicalChannelIdentitySCG_r12_constr_10,  memb_LTE_logicalChannelIdentitySCG_r12_constraint_1 },
		0, 0, /* No default value */
