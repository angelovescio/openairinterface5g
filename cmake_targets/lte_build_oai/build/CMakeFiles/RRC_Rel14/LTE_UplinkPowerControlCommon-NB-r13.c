...
static asn_oer_constraints_t asn_OER_type_LTE_alpha_r13_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_p0_NominalNPUSCH_r13_constr_2 CC_NOTUSED = {
	{ 1, 0 }	/* (-126..24) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_deltaPreambleMsg3_r13_constr_12 CC_NOTUSED = {
	{ 1, 0 }	/* (-1..6) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_alpha_r13_3 = {
	...
	{ &asn_OER_type_LTE_alpha_r13_constr_3, &asn_PER_type_LTE_alpha_r13_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_UplinkPowerControlCommon_NB_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_UplinkPowerControlCommon_NB_r13, p0_NominalNPUSCH_r13),
		...
		0,
		{ &asn_OER_memb_LTE_p0_NominalNPUSCH_r13_constr_2, &asn_PER_memb_LTE_p0_NominalNPUSCH_r13_constr_2,  memb_LTE_p0_NominalNPUSCH_r13_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_UplinkPowerControlCommon_NB_r13, deltaPreambleMsg3_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_deltaPreambleMsg3_r13_constr_12, &asn_PER_memb_LTE_deltaPreambleMsg3_r13_constr_12,  memb_LTE_deltaPreambleMsg3_r13_constraint_1 },
		0, 0, /* No default value */
