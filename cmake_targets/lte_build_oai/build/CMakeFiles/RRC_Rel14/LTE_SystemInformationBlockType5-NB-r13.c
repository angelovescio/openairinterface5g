...
static asn_oer_constraints_t asn_OER_memb_LTE_scptm_FreqOffset_r14_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (1..8) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_LTE_ext1_6[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_SystemInformationBlockType5_NB_r13__ext1, scptm_FreqOffset_r14),
		...
		0,
		{ &asn_OER_memb_LTE_scptm_FreqOffset_r14_constr_7, &asn_PER_memb_LTE_scptm_FreqOffset_r14_constr_7,  memb_LTE_scptm_FreqOffset_r14_constraint_6 },
