...
static asn_oer_constraints_t asn_OER_type_LTE_requestedFrequencyBands_r11_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_requestedFrequencyBands_r11_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
...
asn_TYPE_descriptor_t asn_DEF_LTE_requestedFrequencyBands_r11_2 = {
	...
	{ &asn_OER_type_LTE_requestedFrequencyBands_r11_constr_2, &asn_PER_type_LTE_requestedFrequencyBands_r11_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_UECapabilityEnquiry_v1180_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct LTE_UECapabilityEnquiry_v1180_IEs, requestedFrequencyBands_r11),
		...
		0,
		{ &asn_OER_memb_LTE_requestedFrequencyBands_r11_constr_2, &asn_PER_memb_LTE_requestedFrequencyBands_r11_constr_2,  memb_LTE_requestedFrequencyBands_r11_constraint_1 },
		0, 0, /* No default value */
		"requestedFrequencyBands-r11"
		},
