...
static asn_oer_constraints_t asn_OER_memb_LTE_p0_UE_PeriodicSRS_r14_constr_2 CC_NOTUSED = {
	{ 1, 0 }	/* (-8..7) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_p0_UE_AperiodicSRS_r14_constr_3 CC_NOTUSED = {
	{ 1, 0 }	/* (-8..7) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_UplinkPUSCH_LessPowerControlDedicated_v1430_1[] = {
	{ ATF_POINTER, 2, offsetof(struct LTE_UplinkPUSCH_LessPowerControlDedicated_v1430, p0_UE_PeriodicSRS_r14),
		...
		0,
		{ &asn_OER_memb_LTE_p0_UE_PeriodicSRS_r14_constr_2, &asn_PER_memb_LTE_p0_UE_PeriodicSRS_r14_constr_2,  memb_LTE_p0_UE_PeriodicSRS_r14_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct LTE_UplinkPUSCH_LessPowerControlDedicated_v1430, p0_UE_AperiodicSRS_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_p0_UE_AperiodicSRS_r14_constr_3, &asn_PER_memb_LTE_p0_UE_AperiodicSRS_r14_constr_3,  memb_LTE_p0_UE_AperiodicSRS_r14_constraint_1 },
		0, 0, /* No default value */
