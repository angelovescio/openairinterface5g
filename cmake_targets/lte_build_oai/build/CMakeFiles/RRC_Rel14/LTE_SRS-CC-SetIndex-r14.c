...
static asn_oer_constraints_t asn_OER_memb_LTE_cc_SetIndex_r14_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..3) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_cc_IndexInOneCC_Set_r14_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..7) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_SRS_CC_SetIndex_r14_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SRS_CC_SetIndex_r14, cc_SetIndex_r14),
		...
		0,
		{ &asn_OER_memb_LTE_cc_SetIndex_r14_constr_2, &asn_PER_memb_LTE_cc_SetIndex_r14_constr_2,  memb_LTE_cc_SetIndex_r14_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SRS_CC_SetIndex_r14, cc_IndexInOneCC_Set_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_cc_IndexInOneCC_Set_r14_constr_3, &asn_PER_memb_LTE_cc_IndexInOneCC_Set_r14_constr_3,  memb_LTE_cc_IndexInOneCC_Set_r14_constraint_1 },
		0, 0, /* No default value */
