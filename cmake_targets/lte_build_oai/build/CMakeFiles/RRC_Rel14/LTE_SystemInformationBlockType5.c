...
static asn_oer_constraints_t asn_OER_memb_LTE_scptm_FreqOffset_r14_constr_19 CC_NOTUSED = {
	{ 1, 1 }	/* (1..8) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_lateNonCriticalExtension_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
static asn_TYPE_member_t asn_MBR_LTE_ext6_18[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_SystemInformationBlockType5__ext6, scptm_FreqOffset_r14),
		...
		0,
		{ &asn_OER_memb_LTE_scptm_FreqOffset_r14_constr_19, &asn_PER_memb_LTE_scptm_FreqOffset_r14_constr_19,  memb_LTE_scptm_FreqOffset_r14_constraint_18 },
		0, 0, /* No default value */
...
asn_TYPE_member_t asn_MBR_LTE_SystemInformationBlockType5_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct LTE_SystemInformationBlockType5, lateNonCriticalExtension),
		...
		0,
		{ &asn_OER_memb_LTE_lateNonCriticalExtension_constr_4, &asn_PER_memb_LTE_lateNonCriticalExtension_constr_4,  memb_LTE_lateNonCriticalExtension_constraint_1 },
		0, 0, /* No default value */
