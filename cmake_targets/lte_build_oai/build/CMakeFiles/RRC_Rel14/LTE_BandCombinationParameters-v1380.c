...
static asn_oer_constraints_t asn_OER_type_LTE_bandParameterList_v1380_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..64)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_bandParameterList_v1380_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..64)) */};
...
asn_TYPE_descriptor_t asn_DEF_LTE_bandParameterList_v1380_2 = {
	...
	{ &asn_OER_type_LTE_bandParameterList_v1380_constr_2, &asn_PER_type_LTE_bandParameterList_v1380_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_BandCombinationParameters_v1380_1[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_BandCombinationParameters_v1380, bandParameterList_v1380),
		...
		0,
		{ &asn_OER_memb_LTE_bandParameterList_v1380_constr_2, &asn_PER_memb_LTE_bandParameterList_v1380_constr_2,  memb_LTE_bandParameterList_v1380_constraint_1 },
		0, 0, /* No default value */
		"bandParameterList-v1380"
		},
};
