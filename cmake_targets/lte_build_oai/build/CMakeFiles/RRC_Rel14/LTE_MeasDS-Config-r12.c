...
static asn_oer_constraints_t asn_OER_memb_LTE_ms40_r12_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..39) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_ms80_r12_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (0..79) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_ms160_r12_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (0..159) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_dmtc_PeriodOffset_r12_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_durationFDD_r12_constr_10 CC_NOTUSED = {
	{ 1, 1 }	/* (1..5) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_durationTDD_r12_constr_11 CC_NOTUSED = {
	{ 1, 1 }	/* (2..5) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_ds_OccasionDuration_r12_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_MeasDS_Config_r12_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_LTE_dmtc_PeriodOffset_r12_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_MeasDS_Config_r12__setup__dmtc_PeriodOffset_r12, choice.ms40_r12),
		...
		0,
		{ &asn_OER_memb_LTE_ms40_r12_constr_5, &asn_PER_memb_LTE_ms40_r12_constr_5,  memb_LTE_ms40_r12_constraint_4 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_MeasDS_Config_r12__setup__dmtc_PeriodOffset_r12, choice.ms80_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_ms80_r12_constr_6, &asn_PER_memb_LTE_ms80_r12_constr_6,  memb_LTE_ms80_r12_constraint_4 },
		0, 0, /* No default value */
		"ms80-r12"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_MeasDS_Config_r12__setup__dmtc_PeriodOffset_r12, choice.ms160_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_ms160_r12_constr_7, &asn_PER_memb_LTE_ms160_r12_constr_7,  memb_LTE_ms160_r12_constraint_4 },
		0, 0, /* No default value */
		"ms160-r12"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_LTE_dmtc_PeriodOffset_r12_4 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_dmtc_PeriodOffset_r12_constr_4, &asn_PER_type_LTE_dmtc_PeriodOffset_r12_constr_4, CHOICE_constraint },
...
static asn_TYPE_member_t asn_MBR_LTE_ds_OccasionDuration_r12_9[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_MeasDS_Config_r12__setup__ds_OccasionDuration_r12, choice.durationFDD_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_durationFDD_r12_constr_10, &asn_PER_memb_LTE_durationFDD_r12_constr_10,  memb_LTE_durationFDD_r12_constraint_9 },
		0, 0, /* No default value */
		"durationFDD-r12"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_MeasDS_Config_r12__setup__ds_OccasionDuration_r12, choice.durationTDD_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_durationTDD_r12_constr_11, &asn_PER_memb_LTE_durationTDD_r12_constr_11,  memb_LTE_durationTDD_r12_constraint_9 },
		0, 0, /* No default value */
		"durationTDD-r12"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_LTE_ds_OccasionDuration_r12_9 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_ds_OccasionDuration_r12_constr_9, &asn_PER_type_LTE_ds_OccasionDuration_r12_constr_9, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_LTE_MeasDS_Config_r12 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_MeasDS_Config_r12_constr_1, &asn_PER_type_LTE_MeasDS_Config_r12_constr_1, CHOICE_constraint },
