...
static asn_oer_constraints_t asn_OER_memb_LTE_connEstFailOffset_r13_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_RACH_ConfigCommon_NB_r13_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_RACH_ConfigCommon_NB_r13, connEstFailOffset_r13),
		...
		0,
		{ &asn_OER_memb_LTE_connEstFailOffset_r13_constr_5, &asn_PER_memb_LTE_connEstFailOffset_r13_constr_5,  memb_LTE_connEstFailOffset_r13_constraint_1 },
		0, 0, /* No default value */
