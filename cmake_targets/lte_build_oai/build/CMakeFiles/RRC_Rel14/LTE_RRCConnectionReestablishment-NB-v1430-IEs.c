...
static asn_oer_constraints_t asn_OER_memb_LTE_dl_NAS_MAC_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
asn_TYPE_member_t asn_MBR_LTE_RRCConnectionReestablishment_NB_v1430_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct LTE_RRCConnectionReestablishment_NB_v1430_IEs, dl_NAS_MAC),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_dl_NAS_MAC_constr_2, &asn_PER_memb_LTE_dl_NAS_MAC_constr_2,  memb_LTE_dl_NAS_MAC_constraint_1 },
