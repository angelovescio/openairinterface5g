...
static asn_oer_constraints_t asn_OER_memb_LTE_lateNonCriticalExtension_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
asn_TYPE_member_t asn_MBR_LTE_UE_EUTRA_Capability_v10i0_IEs_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_UE_EUTRA_Capability_v10i0_IEs, lateNonCriticalExtension),
		...
		0,
		{ &asn_OER_memb_LTE_lateNonCriticalExtension_constr_3, &asn_PER_memb_LTE_lateNonCriticalExtension_constr_3,  memb_LTE_lateNonCriticalExtension_constraint_1 },
		0, 0, /* No default value */
