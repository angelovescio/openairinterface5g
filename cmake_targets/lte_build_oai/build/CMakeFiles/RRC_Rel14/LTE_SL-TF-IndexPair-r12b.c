...
static asn_oer_constraints_t asn_OER_memb_LTE_discSF_Index_r12b_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..209) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_discPRB_Index_r12b_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..49) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_SL_TF_IndexPair_r12b_1[] = {
	{ ATF_POINTER, 2, offsetof(struct LTE_SL_TF_IndexPair_r12b, discSF_Index_r12b),
		...
		0,
		{ &asn_OER_memb_LTE_discSF_Index_r12b_constr_2, &asn_PER_memb_LTE_discSF_Index_r12b_constr_2,  memb_LTE_discSF_Index_r12b_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct LTE_SL_TF_IndexPair_r12b, discPRB_Index_r12b),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_discPRB_Index_r12b_constr_3, &asn_PER_memb_LTE_discPRB_Index_r12b_constr_3,  memb_LTE_discPRB_Index_r12b_constraint_1 },
		0, 0, /* No default value */
		"discPRB-Index-r12b"
		},
};
