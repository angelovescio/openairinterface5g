...
static asn_oer_constraints_t asn_OER_type_LTE_multiBandInfoList_r12_constr_12 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
static asn_oer_constraints_t asn_OER_type_LTE_reducedMeasPerformance_r12_constr_14 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_q_RxLevMin_r12_constr_6 CC_NOTUSED = {
	{ 1, 0 }	/* (-60..-13) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_p_MaxUTRA_r12_constr_7 CC_NOTUSED = {
	{ 1, 0 }	/* (-50..33) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_q_QualMin_r12_constr_8 CC_NOTUSED = {
	{ 1, 0 }	/* (-24..0) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_multiBandInfoList_r12_constr_12 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
asn_TYPE_descriptor_t asn_DEF_LTE_multiBandInfoList_r12_12 = {
	...
	{ &asn_OER_type_LTE_multiBandInfoList_r12_constr_12, &asn_PER_type_LTE_multiBandInfoList_r12_constr_12, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_LTE_reducedMeasPerformance_r12_14 = {
	...
	{ &asn_OER_type_LTE_reducedMeasPerformance_r12_constr_14, &asn_PER_type_LTE_reducedMeasPerformance_r12_constr_14, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_CarrierFreqUTRA_FDD_Ext_r12_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_CarrierFreqUTRA_FDD_Ext_r12, q_RxLevMin_r12),
		...
		0,
		{ &asn_OER_memb_LTE_q_RxLevMin_r12_constr_6, &asn_PER_memb_LTE_q_RxLevMin_r12_constr_6,  memb_LTE_q_RxLevMin_r12_constraint_1 },
		0, 0, /* No default value */
		"q-RxLevMin-r12"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_CarrierFreqUTRA_FDD_Ext_r12, p_MaxUTRA_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_p_MaxUTRA_r12_constr_7, &asn_PER_memb_LTE_p_MaxUTRA_r12_constr_7,  memb_LTE_p_MaxUTRA_r12_constraint_1 },
		0, 0, /* No default value */
		"p-MaxUTRA-r12"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_CarrierFreqUTRA_FDD_Ext_r12, q_QualMin_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_q_QualMin_r12_constr_8, &asn_PER_memb_LTE_q_QualMin_r12_constr_8,  memb_LTE_q_QualMin_r12_constraint_1 },
		0, 0, /* No default value */
		"q-QualMin-r12"
		},
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_CarrierFreqUTRA_FDD_Ext_r12, multiBandInfoList_r12),
		...
		0,
		{ &asn_OER_memb_LTE_multiBandInfoList_r12_constr_12, &asn_PER_memb_LTE_multiBandInfoList_r12_constr_12,  memb_LTE_multiBandInfoList_r12_constraint_1 },
		0, 0, /* No default value */
		"multiBandInfoList-r12"
		},
