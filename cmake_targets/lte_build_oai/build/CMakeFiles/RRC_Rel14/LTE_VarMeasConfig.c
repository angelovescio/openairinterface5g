...
static asn_oer_constraints_t asn_OER_type_LTE_speedStatePars_constr_13 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_s_Measure_constr_12 CC_NOTUSED = {
	{ 2, 0 }	/* (-140..-44) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_speedStatePars_13 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_speedStatePars_constr_13, &asn_PER_type_LTE_speedStatePars_constr_13, CHOICE_constraint },
...
static asn_TYPE_member_t asn_MBR_LTE_VarMeasConfig_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct LTE_VarMeasConfig, s_Measure),
		...
		0,
		{ &asn_OER_memb_LTE_s_Measure_constr_12, &asn_PER_memb_LTE_s_Measure_constr_12,  memb_LTE_s_Measure_constraint_1 },
		0, 0, /* No default value */
		"s-Measure"
		},
