...
static asn_oer_constraints_t asn_OER_type_LTE_trafficPeriodicity_r14_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_timingOffset_r14_constr_15 CC_NOTUSED = {
	{ 2, 1 }	/* (0..10239) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_logicalChannelIdentityUL_r14_constr_17 CC_NOTUSED = {
	{ 1, 1 }	/* (3..10) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_messageSize_r14_constr_18 CC_NOTUSED = {
	{ 0, 0 },
	6	/* (SIZE(6..6)) */};
...
asn_TYPE_descriptor_t asn_DEF_LTE_trafficPeriodicity_r14_2 = {
	...
	{ &asn_OER_type_LTE_trafficPeriodicity_r14_constr_2, &asn_PER_type_LTE_trafficPeriodicity_r14_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_TrafficPatternInfo_r14_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_TrafficPatternInfo_r14, timingOffset_r14),
		...
		0,
		{ &asn_OER_memb_LTE_timingOffset_r14_constr_15, &asn_PER_memb_LTE_timingOffset_r14_constr_15,  memb_LTE_timingOffset_r14_constraint_1 },
		0, 0, /* No default value */
		"timingOffset-r14"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct LTE_TrafficPatternInfo_r14, logicalChannelIdentityUL_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_logicalChannelIdentityUL_r14_constr_17, &asn_PER_memb_LTE_logicalChannelIdentityUL_r14_constr_17,  memb_LTE_logicalChannelIdentityUL_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_TrafficPatternInfo_r14, messageSize_r14),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_messageSize_r14_constr_18, &asn_PER_memb_LTE_messageSize_r14_constr_18,  memb_LTE_messageSize_r14_constraint_1 },
		0, 0, /* No default value */
		"messageSize-r14"
		},
};
