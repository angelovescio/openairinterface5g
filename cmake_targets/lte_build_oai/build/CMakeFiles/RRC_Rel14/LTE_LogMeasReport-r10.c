...
static asn_oer_constraints_t asn_OER_memb_LTE_traceRecordingSessionRef_r10_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	2	/* (SIZE(2..2)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_tce_Id_r10_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	1	/* (SIZE(1..1)) */};
...
asn_TYPE_member_t asn_MBR_LTE_LogMeasReport_r10_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_LogMeasReport_r10, traceRecordingSessionRef_r10),
		...
		0,
		{ &asn_OER_memb_LTE_traceRecordingSessionRef_r10_constr_4, &asn_PER_memb_LTE_traceRecordingSessionRef_r10_constr_4,  memb_LTE_traceRecordingSessionRef_r10_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_LogMeasReport_r10, tce_Id_r10),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ &asn_OER_memb_LTE_tce_Id_r10_constr_5, &asn_PER_memb_LTE_tce_Id_r10_constr_5,  memb_LTE_tce_Id_r10_constraint_1 },
		0, 0, /* No default value */
		"tce-Id-r10"
		},
