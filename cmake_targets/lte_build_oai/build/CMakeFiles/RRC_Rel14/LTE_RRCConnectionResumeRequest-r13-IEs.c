...
static asn_oer_constraints_t asn_OER_memb_LTE_truncatedResumeID_r13_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	24	/* (SIZE(24..24)) */};
...
static asn_oer_constraints_t asn_OER_type_LTE_resumeIdentity_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_shortResumeMAC_I_r13_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_spare_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	1	/* (SIZE(1..1)) */};
...
static asn_TYPE_member_t asn_MBR_LTE_resumeIdentity_r13_2[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RRCConnectionResumeRequest_r13_IEs__resumeIdentity_r13, choice.truncatedResumeID_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_truncatedResumeID_r13_constr_4, &asn_PER_memb_LTE_truncatedResumeID_r13_constr_4,  memb_LTE_truncatedResumeID_r13_constraint_2 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_LTE_resumeIdentity_r13_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_resumeIdentity_r13_constr_2, &asn_PER_type_LTE_resumeIdentity_r13_constr_2, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_RRCConnectionResumeRequest_r13_IEs_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RRCConnectionResumeRequest_r13_IEs, shortResumeMAC_I_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_shortResumeMAC_I_r13_constr_5, &asn_PER_memb_LTE_shortResumeMAC_I_r13_constr_5,  memb_LTE_shortResumeMAC_I_r13_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RRCConnectionResumeRequest_r13_IEs, spare),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_spare_constr_7, &asn_PER_memb_LTE_spare_constr_7,  memb_LTE_spare_constraint_1 },
		0, 0, /* No default value */
		"spare"
		},
};
