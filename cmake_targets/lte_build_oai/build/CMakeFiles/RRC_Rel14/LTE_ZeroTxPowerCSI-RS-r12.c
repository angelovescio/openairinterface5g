...
static asn_oer_constraints_t asn_OER_memb_LTE_zeroTxPowerResourceConfigList_r12_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_zeroTxPowerSubframeConfig_r12_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..154) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_ZeroTxPowerCSI_RS_r12_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_ZeroTxPowerCSI_RS_r12, zeroTxPowerResourceConfigList_r12),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_zeroTxPowerResourceConfigList_r12_constr_2, &asn_PER_memb_LTE_zeroTxPowerResourceConfigList_r12_constr_2,  memb_LTE_zeroTxPowerResourceConfigList_r12_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_ZeroTxPowerCSI_RS_r12, zeroTxPowerSubframeConfig_r12),
		...
		0,
		{ &asn_OER_memb_LTE_zeroTxPowerSubframeConfig_r12_constr_3, &asn_PER_memb_LTE_zeroTxPowerSubframeConfig_r12_constr_3,  memb_LTE_zeroTxPowerSubframeConfig_r12_constraint_1 },
		0, 0, /* No default value */
