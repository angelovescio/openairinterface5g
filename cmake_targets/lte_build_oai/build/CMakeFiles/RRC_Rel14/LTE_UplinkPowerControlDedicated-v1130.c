...
static asn_oer_constraints_t asn_OER_memb_LTE_pSRS_Offset_v1130_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (16..31) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_pSRS_OffsetAp_v1130_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (16..31) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_UplinkPowerControlDedicated_v1130_1[] = {
	{ ATF_POINTER, 3, offsetof(struct LTE_UplinkPowerControlDedicated_v1130, pSRS_Offset_v1130),
		...
		0,
		{ &asn_OER_memb_LTE_pSRS_Offset_v1130_constr_2, &asn_PER_memb_LTE_pSRS_Offset_v1130_constr_2,  memb_LTE_pSRS_Offset_v1130_constraint_1 },
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_UplinkPowerControlDedicated_v1130, pSRS_OffsetAp_v1130),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_pSRS_OffsetAp_v1130_constr_3, &asn_PER_memb_LTE_pSRS_OffsetAp_v1130_constr_3,  memb_LTE_pSRS_OffsetAp_v1130_constraint_1 },
		0, 0, /* No default value */
		"pSRS-OffsetAp-v1130"
		},
