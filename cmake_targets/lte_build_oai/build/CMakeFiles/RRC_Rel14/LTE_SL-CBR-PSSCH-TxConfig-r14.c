...
static asn_oer_constraints_t asn_OER_memb_LTE_cr_Limit_r14_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (0..10000) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_SL_CBR_PSSCH_TxConfig_r14_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SL_CBR_PSSCH_TxConfig_r14, cr_Limit_r14),
		...
		0,
		{ &asn_OER_memb_LTE_cr_Limit_r14_constr_2, &asn_PER_memb_LTE_cr_Limit_r14_constr_2,  memb_LTE_cr_Limit_r14_constraint_1 },
