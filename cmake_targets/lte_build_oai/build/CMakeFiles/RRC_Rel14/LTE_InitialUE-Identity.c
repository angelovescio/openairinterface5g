...
static asn_oer_constraints_t asn_OER_memb_LTE_randomValue_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	40	/* (SIZE(40..40)) */};
...
static asn_oer_constraints_t asn_OER_type_LTE_InitialUE_Identity_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_InitialUE_Identity_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_InitialUE_Identity, choice.randomValue),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_randomValue_constr_3, &asn_PER_memb_LTE_randomValue_constr_3,  memb_LTE_randomValue_constraint_1 },
		0, 0, /* No default value */
		"randomValue"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_LTE_InitialUE_Identity = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_InitialUE_Identity_constr_1, &asn_PER_type_LTE_InitialUE_Identity_constr_1, CHOICE_constraint },
