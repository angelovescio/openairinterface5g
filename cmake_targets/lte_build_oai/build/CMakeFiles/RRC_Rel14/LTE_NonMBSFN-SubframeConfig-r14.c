...
static asn_oer_constraints_t asn_OER_type_LTE_radioFrameAllocationPeriod_r14_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_radioFrameAllocationOffset_r14_constr_10 CC_NOTUSED = {
	{ 1, 1 }	/* (0..7) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_subframeAllocation_r14_constr_11 CC_NOTUSED = {
	{ 0, 0 },
	9	/* (SIZE(9..9)) */};
...
asn_TYPE_descriptor_t asn_DEF_LTE_radioFrameAllocationPeriod_r14_2 = {
	...
	{ &asn_OER_type_LTE_radioFrameAllocationPeriod_r14_constr_2, &asn_PER_type_LTE_radioFrameAllocationPeriod_r14_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_NonMBSFN_SubframeConfig_r14_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_NonMBSFN_SubframeConfig_r14, radioFrameAllocationOffset_r14),
		...
		0,
		{ &asn_OER_memb_LTE_radioFrameAllocationOffset_r14_constr_10, &asn_PER_memb_LTE_radioFrameAllocationOffset_r14_constr_10,  memb_LTE_radioFrameAllocationOffset_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_NonMBSFN_SubframeConfig_r14, subframeAllocation_r14),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_subframeAllocation_r14_constr_11, &asn_PER_memb_LTE_subframeAllocation_r14_constr_11,  memb_LTE_subframeAllocation_r14_constraint_1 },
		0, 0, /* No default value */
