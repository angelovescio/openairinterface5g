...
static asn_oer_constraints_t asn_OER_type_LTE_freqBandRetrieval_r11_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_requestedBands_r11_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..64)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_requestedBands_r11_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..64)) */};
...
asn_TYPE_descriptor_t asn_DEF_LTE_freqBandRetrieval_r11_2 = {
	...
	{ &asn_OER_type_LTE_freqBandRetrieval_r11_constr_2, &asn_PER_type_LTE_freqBandRetrieval_r11_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_LTE_requestedBands_r11_4 = {
	...
	{ &asn_OER_type_LTE_requestedBands_r11_constr_4, &asn_PER_type_LTE_requestedBands_r11_constr_4, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_RF_Parameters_v1180_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_RF_Parameters_v1180, requestedBands_r11),
		...
		0,
		{ &asn_OER_memb_LTE_requestedBands_r11_constr_4, &asn_PER_memb_LTE_requestedBands_r11_constr_4,  memb_LTE_requestedBands_r11_constraint_1 },
		0, 0, /* No default value */
		"requestedBands-r11"
		},
