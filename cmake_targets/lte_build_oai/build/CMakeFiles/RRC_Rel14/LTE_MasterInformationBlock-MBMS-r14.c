...
static asn_oer_constraints_t asn_OER_type_LTE_dl_Bandwidth_MBMS_r14_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_systemFrameNumber_r14_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	6	/* (SIZE(6..6)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_additionalNonMBSFNSubframes_r14_constr_10 CC_NOTUSED = {
	{ 1, 1 }	/* (0..3) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_spare_constr_11 CC_NOTUSED = {
	{ 0, 0 },
	13	/* (SIZE(13..13)) */};
...
asn_TYPE_descriptor_t asn_DEF_LTE_dl_Bandwidth_MBMS_r14_2 = {
	...
	{ &asn_OER_type_LTE_dl_Bandwidth_MBMS_r14_constr_2, &asn_PER_type_LTE_dl_Bandwidth_MBMS_r14_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_MasterInformationBlock_MBMS_r14_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_MasterInformationBlock_MBMS_r14, systemFrameNumber_r14),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_systemFrameNumber_r14_constr_9, &asn_PER_memb_LTE_systemFrameNumber_r14_constr_9,  memb_LTE_systemFrameNumber_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_MasterInformationBlock_MBMS_r14, additionalNonMBSFNSubframes_r14),
		...
		0,
		{ &asn_OER_memb_LTE_additionalNonMBSFNSubframes_r14_constr_10, &asn_PER_memb_LTE_additionalNonMBSFNSubframes_r14_constr_10,  memb_LTE_additionalNonMBSFNSubframes_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_MasterInformationBlock_MBMS_r14, spare),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_spare_constr_11, &asn_PER_memb_LTE_spare_constr_11,  memb_LTE_spare_constraint_1 },
		0, 0, /* No default value */
		"spare"
		},
};
