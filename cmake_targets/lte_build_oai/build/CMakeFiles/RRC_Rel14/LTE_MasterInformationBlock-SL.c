...
static asn_oer_constraints_t asn_OER_type_LTE_sl_Bandwidth_r12_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_directFrameNumber_r12_constr_10 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_directSubframeNumber_r12_constr_11 CC_NOTUSED = {
	{ 1, 1 }	/* (0..9) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_reserved_r12_constr_13 CC_NOTUSED = {
	{ 0, 0 },
	19	/* (SIZE(19..19)) */};
...
asn_TYPE_descriptor_t asn_DEF_LTE_sl_Bandwidth_r12_2 = {
	...
	{ &asn_OER_type_LTE_sl_Bandwidth_r12_constr_2, &asn_PER_type_LTE_sl_Bandwidth_r12_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_MasterInformationBlock_SL_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_MasterInformationBlock_SL, directFrameNumber_r12),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_directFrameNumber_r12_constr_10, &asn_PER_memb_LTE_directFrameNumber_r12_constr_10,  memb_LTE_directFrameNumber_r12_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_MasterInformationBlock_SL, directSubframeNumber_r12),
		...
		0,
		{ &asn_OER_memb_LTE_directSubframeNumber_r12_constr_11, &asn_PER_memb_LTE_directSubframeNumber_r12_constr_11,  memb_LTE_directSubframeNumber_r12_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_MasterInformationBlock_SL, reserved_r12),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_reserved_r12_constr_13, &asn_PER_memb_LTE_reserved_r12_constr_13,  memb_LTE_reserved_r12_constraint_1 },
		0, 0, /* No default value */
		"reserved-r12"
		},
};
