...
static asn_oer_constraints_t asn_OER_memb_LTE_nonCriticalExtension_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
asn_TYPE_member_t asn_MBR_LTE_SystemInformationBlockType2_v9i0_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct LTE_SystemInformationBlockType2_v9i0_IEs, nonCriticalExtension),
		...
		0,
		{ &asn_OER_memb_LTE_nonCriticalExtension_constr_2, &asn_PER_memb_LTE_nonCriticalExtension_constr_2,  memb_LTE_nonCriticalExtension_constraint_1 },
