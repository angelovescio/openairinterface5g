...
static asn_oer_constraints_t asn_OER_memb_LTE_ue_CategoryDL_r12_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (0..14) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_ue_CategoryUL_r12_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (0..13) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_UE_EUTRA_Capability_v1250_IEs_1[] = {
	...
	{ ATF_POINTER, 11, offsetof(struct LTE_UE_EUTRA_Capability_v1250_IEs, ue_CategoryDL_r12),
		...
		0,
		{ &asn_OER_memb_LTE_ue_CategoryDL_r12_constr_6, &asn_PER_memb_LTE_ue_CategoryDL_r12_constr_6,  memb_LTE_ue_CategoryDL_r12_constraint_1 },
		0, 0, /* No default value */
		"ue-CategoryDL-r12"
		},
	{ ATF_POINTER, 10, offsetof(struct LTE_UE_EUTRA_Capability_v1250_IEs, ue_CategoryUL_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_ue_CategoryUL_r12_constr_7, &asn_PER_memb_LTE_ue_CategoryUL_r12_constr_7,  memb_LTE_ue_CategoryUL_r12_constraint_1 },
		0, 0, /* No default value */
		"ue-CategoryUL-r12"
		},
