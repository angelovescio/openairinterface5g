...
static asn_oer_constraints_t asn_OER_memb_LTE_meid_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	56	/* (SIZE(56..56)) */};
...
asn_TYPE_member_t asn_MBR_LTE_ULHandoverPreparationTransfer_r8_IEs_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct LTE_ULHandoverPreparationTransfer_r8_IEs, meid),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_meid_constr_3, &asn_PER_memb_LTE_meid_constr_3,  memb_LTE_meid_constraint_1 },
		0, 0, /* No default value */
		"meid"
		},
