...
static asn_oer_constraints_t asn_OER_memb_LTE_subframeConfig0_r11_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	70	/* (SIZE(70..70)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_subframeConfig1_5_r11_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_subframeConfig6_r11_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	60	/* (SIZE(60..60)) */};
...
static asn_oer_constraints_t asn_OER_type_LTE_subframePatternTDD_r11_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_subframePatternFDD_r11_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	4	/* (SIZE(4..4)) */};
...
static asn_oer_constraints_t asn_OER_type_LTE_IDC_SubframePattern_r11_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_LTE_subframePatternTDD_r11_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_IDC_SubframePattern_r11__subframePatternTDD_r11, choice.subframeConfig0_r11),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_subframeConfig0_r11_constr_4, &asn_PER_memb_LTE_subframeConfig0_r11_constr_4,  memb_LTE_subframeConfig0_r11_constraint_3 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_IDC_SubframePattern_r11__subframePatternTDD_r11, choice.subframeConfig1_5_r11),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_subframeConfig1_5_r11_constr_5, &asn_PER_memb_LTE_subframeConfig1_5_r11_constr_5,  memb_LTE_subframeConfig1_5_r11_constraint_3 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_IDC_SubframePattern_r11__subframePatternTDD_r11, choice.subframeConfig6_r11),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_subframeConfig6_r11_constr_6, &asn_PER_memb_LTE_subframeConfig6_r11_constr_6,  memb_LTE_subframeConfig6_r11_constraint_3 },
		0, 0, /* No default value */
		"subframeConfig6-r11"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_LTE_subframePatternTDD_r11_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_subframePatternTDD_r11_constr_3, &asn_PER_type_LTE_subframePatternTDD_r11_constr_3, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_IDC_SubframePattern_r11_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_IDC_SubframePattern_r11, choice.subframePatternFDD_r11),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_subframePatternFDD_r11_constr_2, &asn_PER_memb_LTE_subframePatternFDD_r11_constr_2,  memb_LTE_subframePatternFDD_r11_constraint_1 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_LTE_IDC_SubframePattern_r11 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_IDC_SubframePattern_r11_constr_1, &asn_PER_type_LTE_IDC_SubframePattern_r11_constr_1, CHOICE_constraint },
