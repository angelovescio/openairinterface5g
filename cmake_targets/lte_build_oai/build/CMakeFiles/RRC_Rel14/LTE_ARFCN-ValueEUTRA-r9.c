 ...
 */
static asn_oer_constraints_t asn_OER_type_LTE_ARFCN_ValueEUTRA_r9_constr_1 CC_NOTUSED = {
	{ 4, 1 }	/* (0..262143) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_ARFCN_ValueEUTRA_r9 = {
	...
	sizeof(asn_DEF_LTE_ARFCN_ValueEUTRA_r9_tags_1)
		/sizeof(asn_DEF_LTE_ARFCN_ValueEUTRA_r9_tags_1[0]), /* 1 */
	{ &asn_OER_type_LTE_ARFCN_ValueEUTRA_r9_constr_1, &asn_PER_type_LTE_ARFCN_ValueEUTRA_r9_constr_1, LTE_ARFCN_ValueEUTRA_r9_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
