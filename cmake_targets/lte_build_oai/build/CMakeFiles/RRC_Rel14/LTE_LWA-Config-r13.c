...
static asn_oer_constraints_t asn_OER_memb_LTE_wt_MAC_Address_r14_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	6	/* (SIZE(6..6)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_lwa_WT_Counter_r13_constr_3 CC_NOTUSED = {
	{ 2, 1 }	/* (0..65535) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_LTE_ext1_5[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_LWA_Config_r13__ext1, wt_MAC_Address_r14),
		...
		0,
		{ &asn_OER_memb_LTE_wt_MAC_Address_r14_constr_6, &asn_PER_memb_LTE_wt_MAC_Address_r14_constr_6,  memb_LTE_wt_MAC_Address_r14_constraint_5 },
...
asn_TYPE_member_t asn_MBR_LTE_LWA_Config_r13_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_LWA_Config_r13, lwa_WT_Counter_r13),
		...
		0,
		{ &asn_OER_memb_LTE_lwa_WT_Counter_r13_constr_3, &asn_PER_memb_LTE_lwa_WT_Counter_r13_constr_3,  memb_LTE_lwa_WT_Counter_r13_constraint_1 },
		0, 0, /* No default value */
		"lwa-WT-Counter-r13"
		},
