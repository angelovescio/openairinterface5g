 ...
 */
static asn_oer_constraints_t asn_OER_type_LTE_DRB_Identity_constr_1 CC_NOTUSED = {
	{ 1, 1 }	/* (1..32) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_DRB_Identity = {
	...
	sizeof(asn_DEF_LTE_DRB_Identity_tags_1)
		/sizeof(asn_DEF_LTE_DRB_Identity_tags_1[0]), /* 1 */
	{ &asn_OER_type_LTE_DRB_Identity_constr_1, &asn_PER_type_LTE_DRB_Identity_constr_1, LTE_DRB_Identity_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
