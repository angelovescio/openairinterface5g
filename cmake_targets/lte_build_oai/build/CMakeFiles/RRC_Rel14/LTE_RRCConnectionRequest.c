...
static asn_SEQUENCE_specifics_t asn_SPC_LTE_criticalExtensionsFuture_specs_4 = {
	sizeof(struct LTE_RRCConnectionRequest__criticalExtensions__criticalExtensionsFuture),
	offsetof(struct LTE_RRCConnectionRequest__criticalExtensions__criticalExtensionsFuture, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_LTE_criticalExtensions_2[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RRCConnectionRequest__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
