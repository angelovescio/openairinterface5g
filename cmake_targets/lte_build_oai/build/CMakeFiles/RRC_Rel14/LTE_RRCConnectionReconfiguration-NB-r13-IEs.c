...
static asn_oer_constraints_t asn_OER_type_LTE_dedicatedInfoNASList_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..2)) */};
...
static asn_oer_constraints_t asn_OER_type_LTE_fullConfig_r13_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_dedicatedInfoNASList_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..2)) */};
...
asn_TYPE_descriptor_t asn_DEF_LTE_dedicatedInfoNASList_r13_2 = {
	...
	{ &asn_OER_type_LTE_dedicatedInfoNASList_r13_constr_2, &asn_PER_type_LTE_dedicatedInfoNASList_r13_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_LTE_fullConfig_r13_5 = {
	...
	{ &asn_OER_type_LTE_fullConfig_r13_constr_5, &asn_PER_type_LTE_fullConfig_r13_constr_5, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_RRCConnectionReconfiguration_NB_r13_IEs_1[] = {
	{ ATF_POINTER, 5, offsetof(struct LTE_RRCConnectionReconfiguration_NB_r13_IEs, dedicatedInfoNASList_r13),
		...
		0,
		{ &asn_OER_memb_LTE_dedicatedInfoNASList_r13_constr_2, &asn_PER_memb_LTE_dedicatedInfoNASList_r13_constr_2,  memb_LTE_dedicatedInfoNASList_r13_constraint_1 },
		0, 0, /* No default value */
		"dedicatedInfoNASList-r13"
		},
