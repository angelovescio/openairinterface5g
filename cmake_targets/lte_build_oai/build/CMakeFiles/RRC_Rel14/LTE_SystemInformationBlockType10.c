...
static asn_oer_constraints_t asn_OER_memb_LTE_warningType_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	2	/* (SIZE(2..2)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_dummy_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	50	/* (SIZE(50..50)) */};
...
asn_TYPE_member_t asn_MBR_LTE_SystemInformationBlockType10_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SystemInformationBlockType10, warningType),
		...
		0,
		{ &asn_OER_memb_LTE_warningType_constr_4, &asn_PER_memb_LTE_warningType_constr_4,  memb_LTE_warningType_constraint_1 },
		0, 0, /* No default value */
		"warningType"
		},
	{ ATF_POINTER, 2, offsetof(struct LTE_SystemInformationBlockType10, dummy),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ &asn_OER_memb_LTE_dummy_constr_5, &asn_PER_memb_LTE_dummy_constr_5,  memb_LTE_dummy_constraint_1 },
		0, 0, /* No default value */
		"dummy"
		},
