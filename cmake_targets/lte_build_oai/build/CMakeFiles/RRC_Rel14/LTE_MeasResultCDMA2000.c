...
static asn_oer_constraints_t asn_OER_memb_LTE_pilotPnPhase_constr_5 CC_NOTUSED = {
	{ 2, 1 }	/* (0..32767) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_pilotStrength_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (0..63) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_LTE_measResult_4[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_MeasResultCDMA2000__measResult, pilotPnPhase),
		...
		0,
		{ &asn_OER_memb_LTE_pilotPnPhase_constr_5, &asn_PER_memb_LTE_pilotPnPhase_constr_5,  memb_LTE_pilotPnPhase_constraint_4 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_MeasResultCDMA2000__measResult, pilotStrength),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_pilotStrength_constr_6, &asn_PER_memb_LTE_pilotStrength_constr_6,  memb_LTE_pilotStrength_constraint_4 },
		0, 0, /* No default value */
		"pilotStrength"
		},
};
