...
static asn_oer_constraints_t asn_OER_memb_LTE_n_r12_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	3	/* (SIZE(3..3)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_m_r12_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	8	/* (SIZE(8..8)) */};
...
static asn_TYPE_member_t asn_MBR_LTE_blocksReceived_r12_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_BLER_Result_r12__blocksReceived_r12, n_r12),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_n_r12_constr_4, &asn_PER_memb_LTE_n_r12_constr_4,  memb_LTE_n_r12_constraint_3 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_BLER_Result_r12__blocksReceived_r12, m_r12),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_m_r12_constr_5, &asn_PER_memb_LTE_m_r12_constr_5,  memb_LTE_m_r12_constraint_3 },
		0, 0, /* No default value */
		"m-r12"
		},
};
