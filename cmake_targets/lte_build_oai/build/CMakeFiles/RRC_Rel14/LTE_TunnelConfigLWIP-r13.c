...
static asn_oer_constraints_t asn_OER_memb_LTE_lwip_Counter_r13_constr_6 CC_NOTUSED = {
	{ 2, 1 }	/* (0..65535) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_LTE_ext1_5[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_TunnelConfigLWIP_r13__ext1, lwip_Counter_r13),
		...
		0,
		{ &asn_OER_memb_LTE_lwip_Counter_r13_constr_6, &asn_PER_memb_LTE_lwip_Counter_r13_constr_6,  memb_LTE_lwip_Counter_r13_constraint_5 },
