...
static asn_oer_constraints_t asn_OER_type_LTE_eab_PerPLMN_List_r11_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..6)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_eab_PerPLMN_List_r11_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..6)) */};
...
static asn_oer_constraints_t asn_OER_type_LTE_eab_Param_r11_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_eab_PerPLMN_List_r11_4 = {
	...
	{ &asn_OER_type_LTE_eab_PerPLMN_List_r11_constr_4, &asn_PER_type_LTE_eab_PerPLMN_List_r11_constr_4, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_LTE_eab_Param_r11_2[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SystemInformationBlockType14_r11__eab_Param_r11, choice.eab_PerPLMN_List_r11),
		...
		0,
		{ &asn_OER_memb_LTE_eab_PerPLMN_List_r11_constr_4, &asn_PER_memb_LTE_eab_PerPLMN_List_r11_constr_4,  memb_LTE_eab_PerPLMN_List_r11_constraint_2 },
		0, 0, /* No default value */
		"eab-PerPLMN-List-r11"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_LTE_eab_Param_r11_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_eab_Param_r11_constr_2, &asn_PER_type_LTE_eab_Param_r11_constr_2, CHOICE_constraint },
