...
static asn_oer_constraints_t asn_OER_type_LTE_wlan_OffloadInfoPerPLMN_List_r12_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..6)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_wlan_OffloadInfoPerPLMN_List_r12_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..6)) */};
...
asn_TYPE_descriptor_t asn_DEF_LTE_wlan_OffloadInfoPerPLMN_List_r12_2 = {
	...
	{ &asn_OER_type_LTE_wlan_OffloadInfoPerPLMN_List_r12_constr_2, &asn_PER_type_LTE_wlan_OffloadInfoPerPLMN_List_r12_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_SystemInformationBlockType17_r12_1[] = {
	{ ATF_POINTER, 2, offsetof(struct LTE_SystemInformationBlockType17_r12, wlan_OffloadInfoPerPLMN_List_r12),
		...
		0,
		{ &asn_OER_memb_LTE_wlan_OffloadInfoPerPLMN_List_r12_constr_2, &asn_PER_memb_LTE_wlan_OffloadInfoPerPLMN_List_r12_constr_2,  memb_LTE_wlan_OffloadInfoPerPLMN_List_r12_constraint_1 },
		0, 0, /* No default value */
		"wlan-OffloadInfoPerPLMN-List-r12"
		},
