...
static asn_oer_constraints_t asn_OER_memb_LTE_ue_RadioPagingInfo_r12_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
asn_TYPE_member_t asn_MBR_LTE_UERadioPagingInformation_r12_IEs_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_UERadioPagingInformation_r12_IEs, ue_RadioPagingInfo_r12),
		...
		0,
		{ &asn_OER_memb_LTE_ue_RadioPagingInfo_r12_constr_2, &asn_PER_memb_LTE_ue_RadioPagingInfo_r12_constr_2,  memb_LTE_ue_RadioPagingInfo_r12_constraint_1 },
