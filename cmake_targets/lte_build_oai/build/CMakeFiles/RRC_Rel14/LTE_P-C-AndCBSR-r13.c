...
static asn_oer_constraints_t asn_OER_type_LTE_cbsr_Selection_r13_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_p_C_r13_constr_2 CC_NOTUSED = {
	{ 1, 0 }	/* (-8..15) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_cbsr_Selection_r13_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_cbsr_Selection_r13_constr_3, &asn_PER_type_LTE_cbsr_Selection_r13_constr_3, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_P_C_AndCBSR_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_P_C_AndCBSR_r13, p_C_r13),
		...
		0,
		{ &asn_OER_memb_LTE_p_C_r13_constr_2, &asn_PER_memb_LTE_p_C_r13_constr_2,  memb_LTE_p_C_r13_constraint_1 },
		0, 0, /* No default value */
		"p-C-r13"
		},
