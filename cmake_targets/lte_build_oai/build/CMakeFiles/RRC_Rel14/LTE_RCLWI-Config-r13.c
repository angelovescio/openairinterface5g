...
static asn_oer_constraints_t asn_OER_type_LTE_command_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_command_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_command_constr_2, &asn_PER_type_LTE_command_constr_2, CHOICE_constraint },
