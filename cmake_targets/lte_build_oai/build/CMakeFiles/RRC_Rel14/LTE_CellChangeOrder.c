...
static asn_oer_constraints_t asn_OER_type_LTE_t304_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_networkControlOrder_constr_15 CC_NOTUSED = {
	{ 0, 0 },
	2	/* (SIZE(2..2)) */};
...
static asn_oer_constraints_t asn_OER_type_LTE_targetRAT_Type_constr_11 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_t304_2 = {
	...
	{ &asn_OER_type_LTE_t304_constr_2, &asn_PER_type_LTE_t304_constr_2, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_LTE_geran_12[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_CellChangeOrder__targetRAT_Type__geran, networkControlOrder),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_networkControlOrder_constr_15, &asn_PER_memb_LTE_networkControlOrder_constr_15,  memb_LTE_networkControlOrder_constraint_12 },
		0, 0, /* No default value */
		"networkControlOrder"
		},
...
asn_TYPE_descriptor_t asn_DEF_LTE_targetRAT_Type_11 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_targetRAT_Type_constr_11, &asn_PER_type_LTE_targetRAT_Type_constr_11, CHOICE_constraint },
