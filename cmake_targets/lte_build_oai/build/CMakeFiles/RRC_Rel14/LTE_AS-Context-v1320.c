...
static asn_oer_constraints_t asn_OER_memb_LTE_wlanConnectionStatusReport_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
asn_TYPE_member_t asn_MBR_LTE_AS_Context_v1320_1[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_AS_Context_v1320, wlanConnectionStatusReport_r13),
		...
		0,
		{ &asn_OER_memb_LTE_wlanConnectionStatusReport_r13_constr_2, &asn_PER_memb_LTE_wlanConnectionStatusReport_r13_constr_2,  memb_LTE_wlanConnectionStatusReport_r13_constraint_1 },
