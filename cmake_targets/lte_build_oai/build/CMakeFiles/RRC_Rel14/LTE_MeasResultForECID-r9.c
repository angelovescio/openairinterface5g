...
static asn_oer_constraints_t asn_OER_memb_LTE_ue_RxTxTimeDiffResult_r9_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (0..4095) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_currentSFN_r9_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
...
asn_TYPE_member_t asn_MBR_LTE_MeasResultForECID_r9_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_MeasResultForECID_r9, ue_RxTxTimeDiffResult_r9),
		...
		0,
		{ &asn_OER_memb_LTE_ue_RxTxTimeDiffResult_r9_constr_2, &asn_PER_memb_LTE_ue_RxTxTimeDiffResult_r9_constr_2,  memb_LTE_ue_RxTxTimeDiffResult_r9_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_MeasResultForECID_r9, currentSFN_r9),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_LTE_currentSFN_r9_constr_3, &asn_PER_memb_LTE_currentSFN_r9_constr_3,  memb_LTE_currentSFN_r9_constraint_1 },
		0, 0, /* No default value */
		"currentSFN-r9"
		},
};
