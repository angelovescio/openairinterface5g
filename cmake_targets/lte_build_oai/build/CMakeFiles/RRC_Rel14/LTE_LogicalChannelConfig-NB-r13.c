...
static asn_oer_constraints_t asn_OER_memb_LTE_priority_r13_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..16) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_LogicalChannelConfig_NB_r13_1[] = {
	{ ATF_POINTER, 2, offsetof(struct LTE_LogicalChannelConfig_NB_r13, priority_r13),
		...
		0,
		{ &asn_OER_memb_LTE_priority_r13_constr_2, &asn_PER_memb_LTE_priority_r13_constr_2,  memb_LTE_priority_r13_constraint_1 },
