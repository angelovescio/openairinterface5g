...
static asn_oer_constraints_t asn_OER_memb_LTE_sourceSystemInformationBlockType1Ext_constr_13 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_sourceSystemInformationBlockType1_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_LTE_ext1_12[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_AS_Config__ext1, sourceSystemInformationBlockType1Ext),
		...
		0,
		{ &asn_OER_memb_LTE_sourceSystemInformationBlockType1Ext_constr_13, &asn_PER_memb_LTE_sourceSystemInformationBlockType1Ext_constr_13,  memb_LTE_sourceSystemInformationBlockType1Ext_constraint_12 },
...
asn_TYPE_member_t asn_MBR_LTE_AS_Config_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_AS_Config, sourceSystemInformationBlockType1),
		...
		0,
		{ &asn_OER_memb_LTE_sourceSystemInformationBlockType1_constr_7, &asn_PER_memb_LTE_sourceSystemInformationBlockType1_constr_7,  memb_LTE_sourceSystemInformationBlockType1_constraint_1 },
		0, 0, /* No default value */
