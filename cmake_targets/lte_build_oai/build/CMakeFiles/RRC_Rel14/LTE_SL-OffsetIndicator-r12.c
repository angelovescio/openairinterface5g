...
static asn_oer_constraints_t asn_OER_memb_LTE_small_r12_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (0..319) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_large_r12_constr_3 CC_NOTUSED = {
	{ 2, 1 }	/* (0..10239) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_SL_OffsetIndicator_r12_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_SL_OffsetIndicator_r12_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SL_OffsetIndicator_r12, choice.small_r12),
		...
		0,
		{ &asn_OER_memb_LTE_small_r12_constr_2, &asn_PER_memb_LTE_small_r12_constr_2,  memb_LTE_small_r12_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SL_OffsetIndicator_r12, choice.large_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_large_r12_constr_3, &asn_PER_memb_LTE_large_r12_constr_3,  memb_LTE_large_r12_constraint_1 },
		0, 0, /* No default value */
		"large-r12"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_LTE_SL_OffsetIndicator_r12 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_SL_OffsetIndicator_r12_constr_1, &asn_PER_type_LTE_SL_OffsetIndicator_r12_constr_1, CHOICE_constraint },
