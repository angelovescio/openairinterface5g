...
static asn_oer_constraints_t asn_OER_memb_LTE_extendedWaitTime_CPdata_r14_constr_3 CC_NOTUSED = {
	{ 2, 1 }	/* (1..1800) */,
	-1};
...
static asn_SEQUENCE_specifics_t asn_SPC_LTE_nonCriticalExtension_specs_4 = {
	sizeof(struct LTE_RRCConnectionRelease_NB_v1430_IEs__nonCriticalExtension),
	offsetof(struct LTE_RRCConnectionRelease_NB_v1430_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
asn_TYPE_member_t asn_MBR_LTE_RRCConnectionRelease_NB_v1430_IEs_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_RRCConnectionRelease_NB_v1430_IEs, extendedWaitTime_CPdata_r14),
		...
		0,
		{ &asn_OER_memb_LTE_extendedWaitTime_CPdata_r14_constr_3, &asn_PER_memb_LTE_extendedWaitTime_CPdata_r14_constr_3,  memb_LTE_extendedWaitTime_CPdata_r14_constraint_1 },
		0, 0, /* No default value */
