...
static asn_oer_constraints_t asn_OER_memb_LTE_maxSCH_TB_BitsDL_r12_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..100) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_maxSCH_TB_BitsUL_r12_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (1..100) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_SCG_ConfigRestrictInfo_r12_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SCG_ConfigRestrictInfo_r12, maxSCH_TB_BitsDL_r12),
		...
		0,
		{ &asn_OER_memb_LTE_maxSCH_TB_BitsDL_r12_constr_2, &asn_PER_memb_LTE_maxSCH_TB_BitsDL_r12_constr_2,  memb_LTE_maxSCH_TB_BitsDL_r12_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SCG_ConfigRestrictInfo_r12, maxSCH_TB_BitsUL_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_maxSCH_TB_BitsUL_r12_constr_3, &asn_PER_memb_LTE_maxSCH_TB_BitsUL_r12_constr_3,  memb_LTE_maxSCH_TB_BitsUL_r12_constraint_1 },
		0, 0, /* No default value */
