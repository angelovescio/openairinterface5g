...
static asn_oer_constraints_t asn_OER_memb_LTE_scg_Counter_r12_constr_5 CC_NOTUSED = {
	{ 2, 1 }	/* (0..65535) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_LTE_SCG_Configuration_r12_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_LTE_scg_ConfigPartMCG_r12_4[] = {
	{ ATF_POINTER, 2, offsetof(struct LTE_SCG_Configuration_r12__setup__scg_ConfigPartMCG_r12, scg_Counter_r12),
		...
		0,
		{ &asn_OER_memb_LTE_scg_Counter_r12_constr_5, &asn_PER_memb_LTE_scg_Counter_r12_constr_5,  memb_LTE_scg_Counter_r12_constraint_4 },
...
asn_TYPE_descriptor_t asn_DEF_LTE_SCG_Configuration_r12 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LTE_SCG_Configuration_r12_constr_1, &asn_PER_type_LTE_SCG_Configuration_r12_constr_1, CHOICE_constraint },
