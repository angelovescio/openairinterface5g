...
static asn_oer_constraints_t asn_OER_memb_LTE_srs_SwitchFromServCellIndex_r14_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..31) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_SCellToAddModExt_v1430_1[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_SCellToAddModExt_v1430, srs_SwitchFromServCellIndex_r14),
		...
		0,
		{ &asn_OER_memb_LTE_srs_SwitchFromServCellIndex_r14_constr_2, &asn_PER_memb_LTE_srs_SwitchFromServCellIndex_r14_constr_2,  memb_LTE_srs_SwitchFromServCellIndex_r14_constraint_1 },
