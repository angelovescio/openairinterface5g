...
static asn_oer_constraints_t asn_OER_type_LTE_deltaMCS_Enabled_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_p0_UE_PUSCH_constr_2 CC_NOTUSED = {
	{ 1, 0 }	/* (-8..7) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_p0_UE_PUCCH_constr_7 CC_NOTUSED = {
	{ 1, 0 }	/* (-8..7) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_pSRS_Offset_constr_8 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_deltaMCS_Enabled_3 = {
	...
	{ &asn_OER_type_LTE_deltaMCS_Enabled_constr_3, &asn_PER_type_LTE_deltaMCS_Enabled_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_UplinkPowerControlDedicated_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_UplinkPowerControlDedicated, p0_UE_PUSCH),
		...
		0,
		{ &asn_OER_memb_LTE_p0_UE_PUSCH_constr_2, &asn_PER_memb_LTE_p0_UE_PUSCH_constr_2,  memb_LTE_p0_UE_PUSCH_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_UplinkPowerControlDedicated, p0_UE_PUCCH),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_p0_UE_PUCCH_constr_7, &asn_PER_memb_LTE_p0_UE_PUCCH_constr_7,  memb_LTE_p0_UE_PUCCH_constraint_1 },
		0, 0, /* No default value */
		"p0-UE-PUCCH"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_UplinkPowerControlDedicated, pSRS_Offset),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_pSRS_Offset_constr_8, &asn_PER_memb_LTE_pSRS_Offset_constr_8,  memb_LTE_pSRS_Offset_constraint_1 },
		0, 0, /* No default value */
		"pSRS-Offset"
		},
