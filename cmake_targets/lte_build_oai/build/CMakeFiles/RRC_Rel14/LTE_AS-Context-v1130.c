...
static asn_oer_constraints_t asn_OER_memb_LTE_sidelinkUEInformation_r12_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_idc_Indication_r11_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_mbmsInterestIndication_r11_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
static asn_oer_constraints_t asn_OER_memb_LTE_powerPrefIndication_r11_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
static asn_TYPE_member_t asn_MBR_LTE_ext1_6[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_AS_Context_v1130__ext1, sidelinkUEInformation_r12),
		...
		0,
		{ &asn_OER_memb_LTE_sidelinkUEInformation_r12_constr_7, &asn_PER_memb_LTE_sidelinkUEInformation_r12_constr_7,  memb_LTE_sidelinkUEInformation_r12_constraint_6 },
...
asn_TYPE_member_t asn_MBR_LTE_AS_Context_v1130_1[] = {
	{ ATF_POINTER, 4, offsetof(struct LTE_AS_Context_v1130, idc_Indication_r11),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ &asn_OER_memb_LTE_idc_Indication_r11_constr_2, &asn_PER_memb_LTE_idc_Indication_r11_constr_2,  memb_LTE_idc_Indication_r11_constraint_1 },
		0, 0, /* No default value */
		"idc-Indication-r11"
		},
	{ ATF_POINTER, 3, offsetof(struct LTE_AS_Context_v1130, mbmsInterestIndication_r11),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ &asn_OER_memb_LTE_mbmsInterestIndication_r11_constr_3, &asn_PER_memb_LTE_mbmsInterestIndication_r11_constr_3,  memb_LTE_mbmsInterestIndication_r11_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_AS_Context_v1130, powerPrefIndication_r11),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ &asn_OER_memb_LTE_powerPrefIndication_r11_constr_4, &asn_PER_memb_LTE_powerPrefIndication_r11_constr_4,  memb_LTE_powerPrefIndication_r11_constraint_1 },
		0, 0, /* No default value */
