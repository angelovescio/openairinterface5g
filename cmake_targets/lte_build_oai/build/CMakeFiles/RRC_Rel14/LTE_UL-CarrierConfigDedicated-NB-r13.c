...
asn_TYPE_member_t asn_MBR_LTE_UL_CarrierConfigDedicated_NB_r13_1[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_UL_CarrierConfigDedicated_NB_r13, ul_CarrierFreq_r13),
...
static const int asn_MAP_LTE_UL_CarrierConfigDedicated_NB_r13_oms_1[] = { 0 };
