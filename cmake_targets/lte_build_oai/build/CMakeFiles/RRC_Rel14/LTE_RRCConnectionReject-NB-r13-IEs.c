...
static asn_oer_constraints_t asn_OER_type_LTE_rrc_SuspendIndication_r13_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_extendedWaitTime_r13_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (1..1800) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_LTE_rrc_SuspendIndication_r13_3 = {
	...
	{ &asn_OER_type_LTE_rrc_SuspendIndication_r13_constr_3, &asn_PER_type_LTE_rrc_SuspendIndication_r13_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_LTE_RRCConnectionReject_NB_r13_IEs_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RRCConnectionReject_NB_r13_IEs, extendedWaitTime_r13),
		...
		0,
		{ &asn_OER_memb_LTE_extendedWaitTime_r13_constr_2, &asn_PER_memb_LTE_extendedWaitTime_r13_constr_2,  memb_LTE_extendedWaitTime_r13_constraint_1 },
