...
static asn_oer_constraints_t asn_OER_memb_LTE_betaOffset_ACK_Index_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_betaOffset_RI_Index_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_LTE_betaOffset_CQI_Index_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
asn_TYPE_member_t asn_MBR_LTE_PUSCH_ConfigDedicated_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_PUSCH_ConfigDedicated, betaOffset_ACK_Index),
		...
		0,
		{ &asn_OER_memb_LTE_betaOffset_ACK_Index_constr_2, &asn_PER_memb_LTE_betaOffset_ACK_Index_constr_2,  memb_LTE_betaOffset_ACK_Index_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_PUSCH_ConfigDedicated, betaOffset_RI_Index),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_betaOffset_RI_Index_constr_3, &asn_PER_memb_LTE_betaOffset_RI_Index_constr_3,  memb_LTE_betaOffset_RI_Index_constraint_1 },
		0, 0, /* No default value */
		"betaOffset-RI-Index"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_PUSCH_ConfigDedicated, betaOffset_CQI_Index),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_LTE_betaOffset_CQI_Index_constr_4, &asn_PER_memb_LTE_betaOffset_CQI_Index_constr_4,  memb_LTE_betaOffset_CQI_Index_constraint_1 },
		0, 0, /* No default value */
